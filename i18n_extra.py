...
EXTRA = {
    ...
    "flat to Sea–Tac, from anywhere within 30 miles": ["至机场固定价，30 英里范围内均适用", "fijos al Sea–Tac, desde cualquier punto en 30 millas", "30마일 이내 어디서든 시택 공항 정액", "cố định tới Sea–Tac, từ bất kỳ đâu trong 30 dặm"],
    ...
    "{n} found within 2½ miles of the road, in the order you’ll pass them": ["沿途 4 公里范围内找到 {n} 处，按经过顺序排列", "{n} encontradas a menos de 4 km de la carretera, en el orden en que las pasará", "도로에서 4km 이내에 {n}곳을 찾았으며, 지나가는 순서대로 표시됩니다", "Tìm thấy {n} trạm trong phạm vi 4 km từ đường, xếp theo thứ tự bạn sẽ đi qua"],
