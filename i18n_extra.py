...
# Front page rewrite plus blueprint deck, idea board, add-city and charter
# pricing strings the copy changes left uncovered. Order [zh, es, ko, vi].
EXTRA.update({
    "Everything here": ["这里的一切", "Todo lo de aquí", "여기 있는 모든 것", "Mọi thứ ở đây"],
    "A financial institution built to grow businesses and ideas.": ["一家专门帮企业和点子长大的金融机构。", "Una institución financiera creada para hacer crecer negocios e ideas.", "기업과 아이디어를 키우기 위해 세운 금융 기관.", "Một định chế tài chính được xây dựng để nuôi lớn doanh nghiệp và ý tưởng."],
    "We built this from scratch, out of our own ideas: rides, rentals, and free trip tools that people use. Now we use what we have built to back other people's businesses and ideas. What is the economic moat you want to build? Let's sink it.": ["这些都是我们从零一点点做出来的，全凭自己的点子：叫车、租车，还有大家都在用的免费行程工具。现在，我们想拿做出来的这些，去帮别人的生意和点子也长起来。你想给自己挖一条什么样的护城河？我们一起把它挖深。", "Lo construimos desde cero, con nuestras propias ideas: viajes, alquileres y herramientas de viaje gratuitas que la gente usa. Ahora usamos lo que hemos construido para respaldar los negocios e ideas de otros. ¿Qué foso económico quieres construir? Vamos a cavarlo hondo.", "저희는 저희만의 아이디어로 이것을 처음부터 만들었습니다. 사람들이 쓰는 차량 서비스, 렌탈, 무료 여행 도구입니다. 이제 그렇게 쌓은 것으로 다른 사람의 사업과 아이디어를 뒷받침합니다. 어떤 경제적 해자를 쌓고 싶으신가요? 함께 깊게 파 봅시다.", "Chúng tôi dựng nên điều này từ con số không, bằng chính ý tưởng của mình: dịch vụ đi xe, cho thuê xe và các công cụ lên lịch trình miễn phí mà mọi người đang dùng. Giờ đây, chúng tôi dùng những gì đã dựng để hậu thuẫn cho doanh nghiệp và ý tưởng của người khác. Bạn muốn xây hào kinh tế nào? Hãy cùng đào nó thật sâu."],
    "Share your idea": ["分享你的想法", "Comparte tu idea", "아이디어를 알려주세요", "Chia sẻ ý tưởng của bạn"],
    "Try our services": ["试用我们的服务", "Prueba nuestros servicios", "서비스를 사용해 보세요", "Dùng thử dịch vụ của chúng tôi"],
    "TRY OUR SERVICES": ["试用我们的服务", "PRUEBA NUESTROS SERVICIOS", "서비스를 사용해 보세요", "DÙNG THỬ DỊCH VỤ CỦA CHÚNG TÔI"],
    "Real tools, free to start": ["实用的工具，免费上手", "Herramientas reales, gratis para empezar", "진짜 쓸모 있는 도구, 무료로 시작", "Công cụ thực thụ, dùng thử miễn phí"],
    "Use any of these right now. Free, and no account needed.": ["这些现在就能用。免费，也不用注册。", "Usa cualquiera de estas ahora mismo. Gratis y sin cuenta.", "지금 바로 아무거나 써 보세요. 무료이고 계정도 필요 없습니다.", "Dùng ngay bất kỳ công cụ nào. Miễn phí, không cần tài khoản."],
    "Free trip mapping": ["免费行程地图", "Planificación de viajes gratis", "무료 여행 지도", "Lên lịch trình miễn phí"],
    "Map your next trip on a real map: every stop lights up or dims by drive time, traffic and closing hours. Free to anyone, no sign-in.": ["在真实地图上规划你的下一趟行程：每个景点会按车程、路况和关门时间自动变亮或变暗。人人免费，无需登录。", "Planifica tu próximo viaje en un mapa real: cada parada se enciende o se atenúa según el tiempo de conducción, el tráfico y los horarios de cierre. Gratis para todos, sin registro.", "실제 지도 위에서 다음 여행을 계획하세요. 각 장소가 이동 시간, 교통, 마감 시간에 따라 밝아지거나 어두워집니다. 누구나 무료, 로그인 불필요.", "Lên kế hoạch cho chuyến đi tiếp theo trên bản đồ thật: mỗi điểm dừng sáng lên hoặc mờ đi theo thời gian lái, tình hình giao thông và giờ đóng cửa. Miễn phí cho mọi người, không cần đăng nhập."],
    "Map your trip →": ["规划行程 →", "Planifica tu viaje →", "여행 계획하기 →", "Lên lịch trình →"],
    "Flat-rate Tesla service across Seattle, booked online in seconds, with your invoice sent automatically. No app, no surge games.": ["覆盖整个西雅图的 Tesla 固定价格专车，在线几秒就能约，账单自动开好。不用 App，也没有高峰乱加价。", "Servicio Tesla de tarifa plana por todo Seattle, reservado online en segundos y con la factura enviada automáticamente. Sin app y sin subidas de tarifa.", "시애틀 전역을 아우르는 Tesla 정액 서비스. 온라인에서 몇 초면 예약되고 영수증도 자동으로 갑니다. 앱도, 피크 요금도 없습니다.", "Dịch vụ Tesla giá cố định khắp Seattle, đặt online trong vài giây, hóa đơn tự gửi. Không cần app, không tăng giá giờ cao điểm."],
    "Book a ride →": ["预约用车 →", "Reservar un viaje →", "차량 예약 →", "Đặt xe →"],
    "Rental car": ["租车", "Alquiler de auto", "차량 렌탈", "Thuê xe"],
    "Rent a Tesla from us and earn from a shared pool of rides, with a path to owning the car you drive.": ["从我们这里租一辆 Tesla，靠平台派来的客户订单赚钱，还能一步步把这辆车开成自己的。", "Alquila un Tesla con nosotros y gana con los viajes que compartimos, con un camino para llegar a ser dueño del auto que conduces.", "저희에게서 Tesla를 빌리고, 함께 배정되는 운행으로 수입을 올리세요. 직접 모는 차를 내 것으로 만드는 길도 있습니다.", "Thuê một chiếc Tesla từ chúng tôi và kiếm tiền từ những chuyến khách được chia sẻ, cùng lộ trình để sở hữu chính chiếc xe bạn lái."],
    "See the rental →": ["了解租车 →", "Ver el alquiler →", "렌탈 살펴보기 →", "Xem gói thuê xe →"],
    "TELL JARVIS": ["告诉 JARVIS", "DÍSELO A JARVIS", "자비스에게 알려주세요", "NÓI VỚI JARVIS"],
    "What is not working?": ["哪里不好用？", "¿Qué no funciona?", "무엇이 불편한가요?", "Điều gì chưa ổn?"],
    "Tell us what is not working, or anything else on your mind. Literally anything helps us grow, and we read all of it.": ["告诉我们哪里不好用，或者任何你想说的。真的，任何一句都能帮我们成长，我们每一条都会看。", "Cuéntanos qué no funciona, o cualquier otra cosa que tengas en mente. De verdad, cualquier cosa nos ayuda a crecer, y lo leemos todo.", "무엇이 불편한지, 또는 떠오르는 무엇이든 알려주세요. 정말 어떤 것이든 저희가 성장하는 데 도움이 되고, 모두 읽습니다.", "Hãy cho chúng tôi biết điều gì chưa ổn, hoặc bất cứ điều gì bạn nghĩ tới. Thật sự, bất cứ điều gì cũng giúp chúng tôi tốt lên, và chúng tôi đọc hết."],
    "What is not working, or what would you want? Anything at all.": ["哪里不好用，或者你想要什么？什么都行。", "¿Qué no funciona, o qué te gustaría? Lo que sea.", "무엇이 불편한가요, 아니면 무엇을 바라나요? 무엇이든 좋습니다.", "Điều gì chưa ổn, hay bạn mong muốn gì? Bất cứ điều gì cũng được."],
    "Email or phone, only if you want a reply (optional)": ["邮箱或电话，只有想收到回复才填（可选）", "Correo o teléfono, solo si quieres respuesta (opcional)", "이메일 또는 전화번호, 답장을 원할 때만 (선택)", "Email hoặc số điện thoại, chỉ khi bạn muốn được trả lời (không bắt buộc)"],
    "Send to Jarvis": ["发送给 Jarvis", "Enviar a Jarvis", "자비스에게 보내기", "Gửi cho Jarvis"],
    "The business that earns today: Teslas we rent to drivers, rides for customers, and the partners who refer them. Here is each part, and where you fit.": ["今天真正赚钱的业务：租给司机的 Tesla、载客的专车，还有把客人介绍过来的伙伴。下面是每一环，看看你能站在哪里。", "El negocio que hoy genera ingresos: los Tesla que alquilamos a conductores, los viajes para clientes y los socios que los recomiendan. Aquí está cada parte, y dónde encajas tú.", "오늘 실제로 수익을 내는 사업입니다. 운전자에게 빌려주는 Tesla, 손님을 태우는 운행, 그리고 손님을 소개하는 파트너. 각 부분과 여러분이 설 자리를 소개합니다.", "Mảng kinh doanh sinh lời hôm nay: những chiếc Tesla cho tài xế thuê, các chuyến xe cho khách, và các đối tác giới thiệu khách. Đây là từng phần, và chỗ đứng của bạn."],
    "The software we run the business on": ["我们用来运营业务的软件", "El software con el que operamos el negocio", "저희가 사업을 운영하는 소프트웨어", "Phần mềm chúng tôi dùng để vận hành"],
    "We built our own tools instead of renting someone else's: dispatch, invoicing, the driver and agent paperwork, and the trip-planning tools. Because it is ours, the customer and the data stay with us, and we fix it ourselves the day something breaks.": ["我们没有租别人的系统，而是自己造工具：调度、开账单、司机和代理的手续，还有行程规划工具。因为是自己的，客户和数据都留在我们这里，出了问题当天就能自己修。", "Construimos nuestras propias herramientas en lugar de alquilar las de otros: despacho, facturación, el papeleo de conductores y agentes, y las herramientas de planificación de viajes. Como son nuestras, el cliente y los datos se quedan con nosotros, y el día que algo falla lo arreglamos nosotros mismos.", "남의 시스템을 빌리는 대신 저희 도구를 직접 만들었습니다. 배차, 청구, 운전자·에이전트 서류, 그리고 여행 계획 도구입니다. 저희 것이기에 고객과 데이터가 저희에게 남고, 문제가 생기면 그날 바로 저희가 고칩니다.", "Chúng tôi tự làm công cụ của mình thay vì đi thuê: điều phối, xuất hóa đơn, giấy tờ cho tài xế và đại lý, và các công cụ lên lịch trình. Vì là của mình, khách hàng và dữ liệu ở lại với chúng tôi, và hễ có trục trặc là chúng tôi tự sửa ngay trong ngày."],
    "Dispatch, which driver has which ride": ["调度：哪位司机接哪一单", "Despacho: qué conductor lleva cada viaje", "배차: 어느 운전자가 어느 운행을 맡는지", "Điều phối: tài xế nào nhận chuyến nào"],
    "Invoices, sent and paid": ["账单，开出与收款", "Facturas, enviadas y pagadas", "청구서, 발송과 결제", "Hóa đơn, đã gửi và đã thanh toán"],
    "Driver and agent sign-up and payouts": ["司机与代理的注册和结算", "Alta y pagos de conductores y agentes", "운전자·에이전트 가입과 정산", "Đăng ký và chi trả cho tài xế và đại lý"],
    "The trip planner and the destination book": ["行程规划器和目的地手册", "El planificador de viajes y la guía de destinos", "여행 플래너와 목적지 안내서", "Công cụ lên lịch trình và cẩm nang điểm đến"],
    "What we are building in finance.": ["我们在金融方面正在做的事。", "Lo que estamos construyendo en finanzas.", "금융 분야에서 저희가 만들고 있는 것.", "Những gì chúng tôi đang xây dựng trong lĩnh vực tài chính."],
    "📐 Blueprint Deck": ["📐 蓝图专区", "📐 Colección de planos", "📐 블루프린트 덱", "📐 Bộ bản thiết kế"],
    "Read the lab's blueprints in full. Log in, pay once, and the sheet is yours. A purchase, not an investment.": ["完整阅读实验室的蓝图。登录、一次性付费，这份蓝图就归你。是一次购买，不是投资。", "Lee los planos del laboratorio completos. Inicia sesión, paga una vez y el documento es tuyo. Es una compra, no una inversión.", "연구소의 블루프린트를 전부 읽어 보세요. 로그인하고 한 번 결제하면 그 문서를 소유하게 됩니다. 투자가 아니라 구매입니다.", "Đọc trọn bộ bản thiết kế của lab. Đăng nhập, trả tiền một lần, và bản đó là của bạn. Đây là một giao dịch mua, không phải đầu tư."],
    "Open the deck →": ["打开专区 →", "Abrir la colección →", "덱 열기 →", "Mở bộ bản thiết kế →"],
    "Anyone can pitch a business idea here, free, no account needed. You back a project by getting its": ["任何人都能在这里免费提出商业想法，无需注册。你支持一个项目的方式，是获取它的", "Cualquiera puede proponer aquí una idea de negocio, gratis y sin cuenta. Respaldas un proyecto obteniendo su", "누구나 여기에서 무료로 사업 아이디어를 제안할 수 있습니다, 계정도 필요 없습니다. 프로젝트를 후원하는 방법은 그", "Bất cứ ai cũng có thể nêu ý tưởng kinh doanh ở đây, miễn phí, không cần tài khoản. Bạn hậu thuẫn một dự án bằng cách nhận"],
    "blueprint": ["蓝图", "plano", "블루프린트", "bản thiết kế"],
    ": log in and buy the sheet on the Blueprint Deck. That purchase is how you back the build. It buys the document, not a stake and not a share of any profit.": ["：登录并在蓝图专区购买这份文件。这次购买就是你对项目的支持。你买到的是这份文件，而不是股份，也不是任何利润的分成。", ": inicia sesión y compra el documento en la Colección de planos. Esa compra es tu forma de respaldar el proyecto. Compras el documento, no una participación ni una parte de las ganancias.", ": 로그인해 블루프린트 덱에서 그 문서를 구매하세요. 그 구매가 곧 프로젝트를 후원하는 방법입니다. 사는 것은 문서이며, 지분이나 이익의 배당이 아닙니다.", ": đăng nhập và mua tài liệu đó trên Bộ bản thiết kế. Giao dịch mua đó chính là cách bạn hậu thuẫn dự án. Bạn mua tài liệu, không phải cổ phần và không phải phần chia lợi nhuận nào."],
    "🎤 Speak your idea": ["🎤 说出你的想法", "🎤 Di tu idea", "🎤 아이디어를 말해 보세요", "🎤 Nói ý tưởng của bạn"],
    "Dictate instead of typing. Tap, talk, tap again.": ["用说的，不用打字。点一下，说话，再点一下。", "Dicta en lugar de escribir. Toca, habla y vuelve a tocar.", "타이핑 대신 말로 받아쓰세요. 누르고, 말하고, 다시 누르면 됩니다.", "Đọc thay vì gõ. Chạm, nói, rồi chạm lại."],
    "Are you travelling right now?": ["你正在旅途中吗？", "¿Estás viajando ahora mismo?", "지금 여행 중이신가요?", "Bạn đang đi du lịch phải không?"],
    "Add the city you are in to the map, so the traveller after you finds it. We keep the city, never your exact spot, your address, or your name.": ["把你所在的城市加到地图上，让后来的旅行者也能找到。我们只保留城市，绝不保存你的确切位置、住址或姓名。", "Añade al mapa la ciudad en la que estás, para que la encuentre el viajero que venga después. Guardamos la ciudad, nunca tu ubicación exacta, tu dirección ni tu nombre.", "지금 있는 도시를 지도에 추가해, 다음에 오는 여행자도 찾을 수 있게 해 주세요. 저희는 도시만 저장하고, 정확한 위치나 주소, 이름은 절대 저장하지 않습니다.", "Thêm thành phố bạn đang ở vào bản đồ, để du khách sau bạn tìm thấy. Chúng tôi chỉ giữ tên thành phố, không bao giờ lưu vị trí chính xác, địa chỉ hay tên của bạn."],
    "Add my city": ["添加我的城市", "Añadir mi ciudad", "내 도시 추가", "Thêm thành phố của tôi"],
    "Share my city": ["分享我的城市", "Compartir mi ciudad", "내 도시 공유", "Chia sẻ thành phố của tôi"],
    "Not now": ["暂时不用", "Ahora no", "나중에", "Để sau"],
    "Remove my city from the map": ["把我的城市从地图上移除", "Quitar mi ciudad del mapa", "지도에서 내 도시 삭제", "Xóa thành phố của tôi khỏi bản đồ"],
    "The places we know, attractions and restaurants, with local tips from a licensed guide. One tap sends any of them into the Trip Planner.": ["我们熟悉的地方，景点和餐厅，配上持牌导游的本地建议。一键就能把任何一个加进行程规划器。", "Los lugares que conocemos, atracciones y restaurantes, con consejos locales de un guía autorizado. Con un toque envías cualquiera al planificador de viajes.", "저희가 아는 장소들, 명소와 식당에 면허 있는 가이드의 현지 팁을 더했습니다. 한 번 누르면 그중 무엇이든 여행 플래너로 보냅니다.", "Những nơi chúng tôi biết rõ, điểm tham quan và nhà hàng, kèm mẹo địa phương từ hướng dẫn viên có giấy phép. Một chạm là gửi bất kỳ nơi nào vào công cụ lên lịch trình."],
    "This is a private car held for your day.": ["这是为你这一天专门留出的私人用车。", "Es un auto privado reservado para tu día.", "이 차는 그날 하루를 위해 잡아 둔 전용 차량입니다.", "Đây là xe riêng được giữ cho cả ngày của bạn."],
    "Want it for less? Drop a stop or shorten the day, the price follows the hours. Or ask for a": ["想便宜一点？减少一个停靠点或缩短当天时长，价格随小时数变化。或者，你也可以选择", "¿Lo quieres por menos? Quita una parada o acorta el día, el precio sigue a las horas. O pide un", "더 저렴하게 하고 싶으세요? 정차지를 하나 빼거나 하루를 줄이면 가격은 시간에 따라갑니다. 아니면", "Muốn rẻ hơn? Bỏ một điểm dừng hoặc rút ngắn ngày, giá đi theo số giờ. Hoặc chọn một"],
    "guided tour": ["有导游的行程", "tour guiado", "가이드 투어", "tour có hướng dẫn"],
    "of the same places instead, driven and guided, priced by the guide.": ["游览同样的地方，有人开车也有人讲解，价格由导游定。", "por los mismos lugares, con conductor y guía, con precio fijado por el guía.", "같은 장소를, 운전과 안내를 함께 받으며 도세요. 가격은 가이드가 정합니다.", "tới cùng những nơi đó, có người lái và hướng dẫn, giá do hướng dẫn viên đặt."],
    "Reorder today's stops for less driving, same places": ["重新排列今天的停靠顺序，少开点车，还是那几个地方", "Reordena las paradas de hoy para conducir menos, mismos lugares", "오늘의 정차 순서를 바꿔 운전은 줄이고, 장소는 그대로", "Sắp xếp lại các điểm dừng hôm nay để lái ít hơn, vẫn những nơi đó"],
    "⚡ Tidy the order": ["⚡ 优化顺序", "⚡ Ordenar la ruta", "⚡ 순서 정리", "⚡ Sắp xếp lại thứ tự"],
})
