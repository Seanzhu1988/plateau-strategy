...
class DirectoryRoutesTests(unittest.TestCase):
    ...
    def test_only_public_assets_are_served_with_safe_types_and_fresh_versions(self):
        for path in ['/tour-directory.js','/tour-directory-data.js','/tour-directory.css','/ivy-branding-public.js','/tour-routing.js','/national-mall-walking.json','/philadelphia-walking.json','/harvard-walking.json']:
