...
"The High Line": {
 ...
 "tip": ["由南端进入，出口即达 Chelsea Market，可于此午餐。",
...
"Statue of Liberty ferry": {
 ...
 "tip": ["建议预订当日首班；登冠名额通常提前数周售罄，末班登船在下午。",
...
"Jefferson Memorial": {
 ...
 "tip": ["沿潮汐湖环行一周，可一并参观马丁·路德·金与罗斯福纪念碑。",
...
"Arlington National Cemetery": {
 ...
 "tip": ["建议配合换岗仪式时间前往：整点举行，夏季每半小时一次。",
...
"Ben's Chili Bowl": {
 ...
 "tip": ["点单时说明「all the way」，即配芥末、洋葱与辣肉酱。",
...
"Pike Place Market": {
 ...
 "tip": ["建议十点前到达，可见鱼贩布置摊位；下层区域不宜错过，多数访客未曾发现。",
...
"Chihuly Garden and Glass": {
 ...
 "tip": ["可与太空针塔购买联票；午后偏晚的光线下，玻璃屋最为动人。",
...
"Museum of Pop Culture": {
 ...
 "tip": ["Sound Lab 可实际演奏乐器，值得留出最后半小时。",
...
"Kerry Park viewpoint": {
 ...
 "tip": ["日落后三十分钟前往，即是蓝调时刻，西雅图各式海报皆摄于此时。",
...
"Starbucks Reserve Roastery": {
 ...
 "tip": ["建议于体验吧点选一组对比品鉴，并观看烘焙机运作；寻常拿铁各处皆有。",
...
"Freedom Trail (start)": {
 ...
 "tip": ["午后由北向南行走，可背向日光；标示的九十分钟仅为步行时间，入内参观将增至一倍。",
...
"Faneuil Hall Marketplace": {
 ...
 "tip": ["Quincy Market 正午拥挤，宜十一时或两时后用餐，并移至东门外长椅。",
...
"Fenway Park": {
 ...
 "tip": ["非比赛日提供一小时球场导览，可登上「绿色怪物」看台；名额有限须提前预订，亦是无票入场的唯一途径。",
...
"Museum of Fine Arts": {
 ...
 "tip": ["周三至周五傍晚人流最少；仅「美洲艺术」一翼即值得两小时。",
...
"New England Aquarium": {
 ...
 "tip": ["宜于开馆时或闭馆前九十分钟前往；正午环缸坡道拥挤，仅容单列通行。",
...
"USS Constitution": {
 ...
 "tip": ["免费登舰，成人须出示附照片证件。邻近博物馆另行计费，值得再留半小时。",
...
"Boston Common & Public Garden": {
 ...
 "tip": ["天鹅船仅于四月中旬至劳动节运营。此处是波士顿一日行程的自然起点，地下有三条地铁线交汇。",
...
"Harvard Yard, Cambridge": {
 ...
 "tip": ["建议乘红线至 Harvard 站，不宜自驾，剑桥停车确实困难。游客中心有学生带领的免费导览。",
