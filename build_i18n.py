...
"An integrated business ecosystem creating opportunity for the people who ride, drive, and grow with us.": ["一个环环相扣的商业生态，为搭我们车、替我们开车、和我们一起成长的每个人创造机会。","Un ecosistema de negocio integrado que abre oportunidades para quienes viajan, conducen y crecen con nosotros.","우리 차를 타는 분, 우리 차를 모는 분, 우리와 함께 성장하는 모든 분께 기회를 여는 하나로 연결된 비즈니스 생태계입니다.","Một hệ sinh thái kinh doanh gắn kết, mở ra cơ hội cho những ai đi xe, cầm lái và cùng lớn mạnh với chúng tôi."],
...
"We're currently validating the market and preparing to launch. Early partners, investors, and team members are critical to our success.": ["我们目前正在验证市场并准备启动。早期合作伙伴、投资者和团队成员对我们的成功至关重要。","Actualmente estamos validando el mercado y preparándonos para el lanzamiento. Los socios, inversionistas y miembros del equipo iniciales son fundamentales para nuestro éxito.","현재 시장을 검증하고 출시를 준비하고 있습니다. 초기 파트너, 투자자, 팀원이 우리의 성공에 매우 중요합니다.","Chúng tôi đang xác thực thị trường và chuẩn bị ra mắt. Các đối tác, nhà đầu tư và thành viên nhóm ban đầu có vai trò then chốt với thành công của chúng tôi."],
"Get Early Access": ["获取抢先体验","Obtén acceso anticipado","얼리 액세스 받기","Nhận quyền truy cập sớm"],
"We're building something ambitious. Join our community of early believers.": ["我们正在打造一项雄心勃勃的事业。加入我们早期信仰者的社区。","Estamos construyendo algo ambicioso. Únete a nuestra comunidad de creyentes tempranos.","우리는 야심 찬 것을 만들고 있습니다. 초기 지지자 커뮤니티에 함께하세요.","Chúng tôi đang xây dựng điều gì đó đầy tham vọng. Hãy tham gia cộng đồng những người tin tưởng từ sớm."],
"Our flagship business — affordable Tesla rentals powering rides, drivers, and referral partners. Here's what we do, and where you fit in.": ["我们的招牌业务 —— 实惠的 Tesla 租赁，撑起用车、司机和推荐伙伴三方。看看我们做什么，以及您能站在哪一环。","Nuestro negocio estrella: alquileres de Tesla asequibles que impulsan los viajes, los conductores y los socios de referidos. Esto hacemos, y aquí encajas tú.","우리의 대표 사업 — 합리적인 Tesla 렌탈이 승차·운전자·추천 파트너를 하나로 이어 줍니다. 우리가 하는 일과, 당신이 설 자리를 소개합니다.","Hoạt động chủ lực của chúng tôi — cho thuê Tesla giá tốt, tiếp sức cho chuyến đi, tài xế và đối tác giới thiệu. Đây là việc chúng tôi làm, và chỗ đứng của bạn."],
...
"Our financial products — choose one to explore.": ["我们的金融产品 —— 选择一个进行探索。","Nuestros productos financieros — elige uno para explorar.","우리의 금융 상품 — 하나를 선택해 살펴보세요.","Các sản phẩm tài chính của chúng tôi — chọn một để khám phá."],
"AI Debt Eliminator": ["AI 债务消除器","Eliminador de deudas con IA","AI 부채 소멸기","Trình xóa nợ AI"],
"Your paycheck's profits automatically pay down your debt — principal never at risk. From $14.17/mo.": ["您薪水产生的利润自动偿还您的债务 —— 本金永不承担风险。低至 $14.17/月。","Las ganancias de tu sueldo pagan tu deuda automáticamente — el capital nunca está en riesgo. Desde $14.17/mes.","당신의 급여에서 나온 수익이 자동으로 부채를 갚습니다 — 원금은 절대 위험에 노출되지 않습니다. 월 $14.17부터.","Lợi nhuận từ tiền lương của bạn tự động trả bớt nợ — tiền gốc không bao giờ gặp rủi ro. Từ $14.17/tháng."],
"Open →": ["打开 →","Abrir →","열기 →","Mở →"],
"RESEARCH": ["研究","INVESTIGACIÓN","리서치","NGHIÊN CỨU"],
"Our automated crypto-trading research project — in private verification, building an audited track record. Nothing for sale yet; follow the results.": ["我们的自动化加密交易研究项目 —— 正处于私密验证阶段，正在建立经审计的业绩记录。目前尚无任何出售；请关注结果。","Nuestro proyecto de investigación de trading automatizado de criptomonedas — en verificación privada, construyendo un historial auditado. Nada a la venta todavía; sigue los resultados.","우리의 자동화 암호화폐 트레이딩 연구 프로젝트 — 비공개 검증 단계로, 감사된 실적을 쌓고 있습니다. 아직 판매 상품은 없습니다; 결과를 지켜봐 주세요.","Dự án nghiên cứu giao dịch tiền mã hóa tự động của chúng tôi — đang trong giai đoạn xác minh riêng tư, xây dựng hồ sơ thành tích được kiểm toán. Chưa có gì để bán; hãy theo dõi kết quả."],
...
"Your paycheck works while you sleep — profits go straight to your debt, and your principal is never at risk.": ["您的薪水在您睡觉时也在工作 —— 利润直接用于偿还债务，而您的本金永不承担风险。","Tu sueldo trabaja mientras duermes — las ganancias van directo a tu deuda y tu capital nunca está en riesgo.","당신이 자는 동안에도 급여가 일합니다 — 수익은 곳바로 부채로 가고, 원금은 절대 위험에 노출되지 않습니다.","Tiền lương của bạn làm việc khi bạn ngủ — lợi nhuận đi thẳng vào khoản nợ, và tiền gốc không bao giờ gặp rủi ro."],
...
"Our AI trades the balance during a 1–2 week window": ["我们的 AI 在 1–2 周的窗口期内交易该余额","Nuestra IA opera con el saldo durante una ventana de 1–2 semanas","우리 AI가 1–2주 동안 잔액을 거래합니다","AI của chúng tôi giao dịch số dư trong khoảng 1–2 tuần"],
...
"This is your unique agent code —": ["这是您专属的代理代码 ——","Este es tu código de agente único —","이것은 당신의 고유 에이전트 코드입니다 —","Đây là mã đại lý riêng của bạn —"],
