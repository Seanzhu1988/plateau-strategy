...
TR = {
"THE MET": ["大都会","THE MET","더 멧","THE MET"],
"NEW · THE INDOOR GUIDE": ["新品 · 室内导览","NUEVO · LA GUÍA DE INTERIORES","신규 · 실내 가이드","MỚI · HƯỚNG DẪN TRONG NHÀ"],
"Walk the Met before you arrive": ["抵达之前，先走一遍大都会","Recorre el Met antes de llegar","도착 전에 메트를 미리 걸어보세요","Đi dạo bảo tàng Met trước khi bạn đến"],
"A 3D model of the Metropolitan Museum you can turn and open: tap the building and it unfolds floor by floor, pick your galleries, and the guide narrates them room by room while footprints trace your route. This is the design behind our indoor guide, live today.": ["一座可以旋转、可以打开的大都会博物馆3D模型：点按建筑，它逐层展开；选好展厅，导览逐个房间为你讲解，足迹沿路线一步步走过。这就是我们室内导览背后的设计，今天就能体验。","Un modelo 3D del Museo Metropolitano que puedes girar y abrir: toca el edificio y se despliega piso por piso, elige tus salas, y la guía las narra sala por sala mientras las huellas trazan tu ruta. Este es el diseño detrás de nuestra guía de interiores, disponible hoy.","돌리고 열 수 있는 메트로폴리탄 미술관 3D 모델: 건물을 누르면 층별로 펼쳐지고, 전시실을 고르면 가이드가 방마다 설명하며 발자국이 경로를 따라 걷습니다. 오늘 바로 체험할 수 있는 실내 가이드의 설계입니다.","Mô hình 3D Bảo tàng Metropolitan bạn có thể xoay và mở: chạm vào tòa nhà, nó mở ra từng tầng; chọn phòng trưng bày, hướng dẫn viên thuyết minh từng phòng trong khi dấu chân vẽ nên lộ trình của bạn. Đây là thiết kế đằng sau hướng dẫn trong nhà của chúng tôi, dùng được ngay hôm nay."],
"Open the museum →": ["打开博物馆 →","Abre el museo →","박물관 열기 →","Mở bảo tàng →"],
"no drawn corridor reaches it yet · kept in your picks, left out of the plan and the times": ["目前还没有已绘制的通道能到达它 · 保留在你的选择中，但未计入路线和时间","ningún pasillo dibujado llega aún · se mantiene en tu selección, fuera del plan y de los tiempos","아직 그려진 통로가 닿지 않습니다 · 선택에는 남아 있지만 일정과 시간에서는 제외됩니다","chưa có hành lang nào được vẽ tới đó · vẫn giữ trong lựa chọn của bạn, nhưng không tính vào lộ trình và thời gian"],
"Not in the book yet — creating it for you…": ["书里还没有它 — 正在为你创建…","Aún no está en el libro — creándolo para ti…","아직 책에 없어요 — 지금 만들어 드릴게요…","Chưa có trong sách — đang tạo cho bạn…"],
"No matches, try adding the city name.": ["没有找到，试试加上城市名。","Sin resultados, prueba añadiendo el nombre de la ciudad.","일치하는 곳이 없어요. 도시 이름을 붙여 보세요.","Không tìm thấy, hãy thử thêm tên thành phố."],
"Not in the book yet": ["书里还没有它","Aún no está en el libro","아직 책에 없어요","Chưa có trong sách"],
"Create this destination": ["创建这个目的地","Crear este destino","이 목적지 만들기","Tạo điểm đến này"],
"Creating it for you…": ["正在为你创建…","Creándolo para ti…","만들고 있어요…","Đang tạo cho bạn…"],
"{n} travellers reading the book right now": ["现在有 {n} 位旅行者正在看这本书","{n} viajeros están leyendo el libro ahora mismo","지금 {n}명의 여행자가 이 책을 보고 있어요","{n} du khách đang đọc sách ngay lúc này"],
"{n} travellers opened the book this week": ["本周有 {n} 位旅行者打开过这本书","{n} viajeros abrieron el libro esta semana","이번 주 {n}명의 여행자가 이 책을 열었어요","{n} du khách đã mở sách trong tuần này"],
"{n} new places added this week": ["本周新增 {n} 个地点","{n} lugares nuevos añadidos esta semana","이번 주 새로 추가된 장소 {n}곳","{n} địa điểm mới được thêm trong tuần này"],
"Been here? Tell us what you paid": ["来过吗？告诉我们你花了多少","¿Has estado? Dinos cuánto pagaste","가보셨나요? 얼마 내셨는지 알려주세요","Bạn đã đến chưa? Cho chúng tôi biết bạn đã trả bao nhiêu"],
"travellers paid about ${n}": ["旅行者大约花了 {n} 美元","los viajeros pagaron unos {n} $","여행자들은 약 {n}달러를 냈어요","du khách trả khoảng {n} đô la"],
"{n} travellers reported": ["{n} 位旅行者反馈","{n} viajeros lo reportaron","{n}명의 여행자가 알려줬어요","{n} du khách đã báo"],
"reported by a guide": ["由导游提供","informado por un guía","가이드가 알려준 정보","do hướng dẫn viên cung cấp"],
"not confirmed in over a year": ["一年多未有人确认","sin confirmar desde hace más de un año","1년 넘게 확인되지 않음","hơn một năm chưa được xác nhận"],
"confirmed recently": ["近期已确认","confirmado recientemente","최근 확인됨","vừa được xác nhận"],
"What did you pay, in US dollars?": ["你花了多少美元？","¿Cuánto pagaste, en dólares?","얼마를 내셨나요? (미국 달러)","Bạn đã trả bao nhiêu đô la Mỹ?"],
"Thank you, ${n} recorded": ["谢谢，已记录 {n} 美元","Gracias, {n} $ registrado","감사합니다, {n}달러 기록됨","Cảm ơn, đã ghi {n} đô la"],
"travellers now say about ${n}": ["旅行者现在的说法是约 {n} 美元","los viajeros ahora dicen unos {n} $","여행자들은 이제 약 {n}달러라고 해요","du khách hiện nói khoảng {n} đô la"],
"one more answer and this becomes the published price": ["再有一个人回答，这就会成为公开价格","una respuesta más y este será el precio publicado","한 명만 더 답하면 공개 가격이 됩니다","thêm một câu trả lời nữa là thành giá công bố"],
"Could not save that.": ["无法保存。","No se pudo guardar.","저장하지 못했습니다.","Không thể lưu."],
"Could not reach the server.": ["无法连接服务器。","No se pudo conectar al servidor.","서버에 연결할 수 없습니다.","Không kết nối được máy chủ."],
"See the menu": ["查看菜单","Ver el menú","메뉴 보기","Xem thực đơn"],
"takeaway": ["可外带","para llevar","포장 가능","mang đi"],
"delivery": ["可配送","a domicilio","배달 가능","giao tận nơi"],
"outdoor seating": ["有户外座位","terraza","야외 좌석","chỗ ngồi ngoài trời"],
"reservations": ["可预订","con reserva","예약 가능","nhận đặt bàn"],
"step-free": ["无障碍通道","sin escalones","계단 없음","không bậc thang"],
"vegetarian": ["有素食","vegetariano","채식 가능","có món chay"],
"vegan": ["有纯素","vegano","비건 가능","thuần chay"],
"kosher": ["洁食","kosher","코셔","kosher"],
"halal": ["清真","halal","할랄","halal"],
"air conditioned": ["有空调","con aire acondicionado","에어컨 있음","có máy lạnh"],
"← All rooms": ["← 所有展厅","← Todas las salas","← 전체 전시실","← Tất cả các phòng"],
"▶ Hear this room": ["▶ 听这个展厅","▶ Escucha esta sala","▶ 이 방 듣기","▶ Nghe phòng này"],
"+ Add to my walk": ["+ 加入我的路线","+ Añadir a mi recorrido","+ 내 경로에 추가","+ Thêm vào lộ trình"],
"✓ In your walk · tap to remove": ["✓ 已在路线中 · 点按移除","✓ En tu recorrido · toca para quitar","✓ 경로에 있음 · 눌러서 제거","✓ Đã trong lộ trình · chạm để xóa"],
"stops in walking order · positions approximate": ["站点按步行顺序 · 位置为示意","paradas en orden de recorrido · posiciones aproximadas","도보 순서의 정거장 · 위치는 대략적","các điểm dừng theo thứ tự đi bộ · vị trí gần đúng"],
"Egyptian Art": ["埃及艺术","Arte egipcio","이집트 미술","Nghệ thuật Ai Cập"],
"The Tomb of Perneb": ["珀内布之墓","La tumba de Perneb","페르네브의 무덤","Lăng mộ Perneb"],
"William the hippopotamus": ["河马威廉","Guillermo el hipopótamo","하마 윌리엄","Hà mã William"],
"The statues of Hatshepsut": ["哈特谢普苏特雕像","Las estatuas de Hatshepsut","하트셉수트 조각상","Các bức tượng Hatshepsut"],
"Photograph by Arad,": ["摄影：Arad，","Fotografía de Arad,","사진: Arad,","Ảnh của Arad,"],
...
"The guide": ["导览","La guía","가이드","Hướng dẫn viên"],
"Your walk, narrated": ["为你的路线讲解","Tu recorrido, narrado","내 동선, 해설과 함께","Lộ trình của bạn, có thuyết minh"],
"Pick galleries on the model and press play. The guide talks you through them in order, and the room it is describing lights up beside it.": ["在模型上选择展厅，然后按播放。导览会按顺序为你讲解，正在讲解的展厅会在旁边亮起。","Elige salas en el modelo y pulsa reproducir. La guía te las explica en orden, y la sala que describe se ilumina al lado.","모형에서 전시실을 고르고 재생을 누르세요. 가이드가 순서대로 설명하고, 설명 중인 전시실이 옆에서 밝아집니다.","Chọn các phòng trên mô hình rồi nhấn phát. Hướng dẫn viên sẽ lần lượt thuyết minh, và căn phòng đang được nói tới sẽ sáng lên bên cạnh."],
"▶ Play the guide": ["▶ 播放导览","▶ Reproducir la guía","▶ 가이드 재생","▶ Phát hướng dẫn"],
"❚❚ Pause the guide": ["❚❚ 暂停导览","❚❚ Pausar la guía","❚❚ 가이드 일시정지","❚❚ Tạm dừng hướng dẫn"],
"Skip ahead": ["跳到下一段","Saltar adelante","건너뛰기","Bỏ qua"],
"the walking guide": ["步行导览","la guía a pie","도보 가이드","hướng dẫn đi bộ"],
"Tap the galleries you want on the model, then press play and the guide walks you through them.": ["在模型上点选你想去的展厅，然后按播放，导览会带你走一遍。","Toca en el modelo las salas que quieras, pulsa reproducir y la guía te las recorre.","모형에서 원하는 전시실을 누른 뒤 재생을 누르면 가이드가 안내합니다.","Chạm vào các phòng bạn muốn trên mô hình, rồi nhấn phát để hướng dẫn viên dẫn bạn đi."],
"The Metropolitan Museum of Art": ["大都会艺术博物馆","El Museo Metropolitano de Arte","메트로폴리탄 미술관","Bảo tàng Nghệ thuật Metropolitan"],
"Five thousand years of art, in a building of eleven and a half acres.": ["五千年的艺术，坐落在十一英亩半的建筑之中。","Cinco mil años de arte, en un edificio de once acres y medio.","5천 년의 예술이, 11.5에이커의 건물 안에 있습니다.","Năm nghìn năm nghệ thuật, trong một tòa nhà rộng mười một mẫu rưỡi."],
"Eleven and a half acres. Tap the building to go inside.": ["十一英亩半。点按建筑即可进入内部。","Once acres y medio. Toca el edificio para entrar.","11.5에이커. 건물을 누르면 안으로 들어갑니다.","Mười một mẫu rưỡi. Chạm vào tòa nhà để vào bên trong."],
"Where travellers came from →": ["旅行者来自何方 →","De dónde vinieron los viajeros →","여행자들이 어디서 왔는지 →","Du khách đến từ đâu →"],
"The map of visitor cities, countries, and how they found you": ["访客城市、国家，以及他们如何找到你的地图","El mapa de ciudades y países de los visitantes, y cómo te encontraron","방문자의 도시와 국가, 그리고 그들이 당신을 찾은 경로 지도","Bản đồ các thành phố, quốc gia của khách và cách họ tìm thấy bạn"],
"Inside the Met, a footprint map · Plateau Strategy": ["大都会博物馆内部，足迹地图 · Plateau Strategy","Dentro del Met, un mapa de huellas · Plateau Strategy","메트 내부, 발자국 지도 · Plateau Strategy","Bên trong bảo tàng Met, bản đồ dấu chân · Plateau Strategy"],
"Trip planner": ["行程规划","Planificador de viaje","여행 플래너","Lập kế hoạch chuyến đi"],
"Inside the Met, on footprints": ["循着足迹，走进大都会博物馆","Dentro del Met, sobre huellas","발자국을 따라, 메트 안에서","Bên trong Met, theo dấu chân"],
"The map on your phone goes grey the moment you step inside. This is a schematic of the Metropolitan Museum of Art, drawn by us, not to scale, with the rooms where they really sit. Tap the rooms you want in the order you want them, and footprints walk the route with honest times.": ["你一走进室内，手机上的地图就会变灰。这是我们绘制的大都会艺术博物馆示意图，非按比例，但展厅位置真实。按你想去的顺序点选展厅，足迹会带你走完全程，并给出诚实的用时。","El mapa de tu teléfono se vuelve gris en cuanto entras. Este es un esquema del Museo Metropolitano de Arte, dibujado por nosotros, sin escala, con las salas donde realmente están. Toca las salas que quieras en el orden que quieras, y las huellas recorren la ruta con tiempos honestos.","실내에 들어서는 순간 휴대폰 지도는 회색이 됩니다. 이것은 우리가 그린 메트로폴리탄 미술관의 개략도로, 축척은 맞지 않지만 전시실 위치는 실제와 같습니다. 원하는 순서대로 전시실을 누르면 발자국이 정직한 소요 시간과 함께 경로를 걸어 줍니다.","Bản đồ trên điện thoại chuyển sang màu xám ngay khi bạn bước vào trong. Đây là sơ đồ Bảo tàng Nghệ thuật Metropolitan do chúng tôi vẽ, không theo tỷ lệ, nhưng các phòng nằm đúng vị trí thật. Chạm vào các phòng theo thứ tự bạn muốn, và dấu chân sẽ đi hết tuyến đường với thời gian trung thực."],
"Times marked with a tilde are estimates until one of our surveyors walks that corridor with the recorder. A walked corridor shows its measured minutes. That is the footprint rule: a person who knows the way walks it once, and the walk becomes the map.": ["带波浪号的时间是估算值，直到我们的测绘员用记录器走过那条通道为止。走过的通道会显示实测分钟数。这就是足迹规则：认路的人走一次，这段路就成了地图。","Los tiempos marcados con una tilde son estimaciones hasta que uno de nuestros topógrafos recorre ese pasillo con la grabadora. Un pasillo recorrido muestra sus minutos medidos. Esa es la regla de la huella: alguien que conoce el camino lo recorre una vez, y el recorrido se convierte en el mapa.","물결표가 붙은 시간은 우리 측량자가 기록기를 들고 그 통로를 걷기 전까지는 추정치입니다. 걸어 본 통로는 실측 분을 보여 줍니다. 그것이 발자국 규칙입니다: 길을 아는 사람이 한 번 걸으면, 그 걸음이 지도가 됩니다.","Thời gian có dấu ngã là ước tính cho đến khi một người khảo sát của chúng tôi đi qua hành lang đó với máy ghi. Hành lang đã đi qua sẽ hiển thị số phút đo được. Đó là quy tắc dấu chân: một người biết đường đi một lần, và chuyến đi ấy trở thành bản đồ."],
"Project ·": ["项目 ·","Proyecto ·","프로젝트 ·","Dự án ·"],
"Footprints": ["足迹","Huellas","발자국","Dấu chân"],
"Sheet ·": ["图纸 ·","Lámina ·","도면 ·","Bản vẽ ·"],
"MET-01 · Floor 1": ["MET-01 · 一层","MET-01 · Planta 1","MET-01 · 1층","MET-01 · Tầng 1"],
"Scale ·": ["比例 ·","Escala ·","축척 ·","Tỷ lệ ·"],
"not to scale": ["非按比例","sin escala","축척 없음","không theo tỷ lệ"],
"Drawn ·": ["绘制 ·","Dibujado ·","작도 ·","Vẽ bởi ·"],
"our own schematic": ["我们自绘的示意图","nuestro propio esquema","자체 제작 개략도","sơ đồ của chúng tôi"],
"Floor 1": ["一层","Planta 1","1층","Tầng 1"],
"Floor 2": ["二层","Planta 2","2층","Tầng 2"],
"3D": ["3D","3D","3D","3D"],
"← Outside": ["← 回到外部","← Al exterior","← 바깥으로","← Ra ngoài"],
"▢ a named room. Tap to add it to your walk.": ["▢ 已命名的展厅。点按即可加入你的路线。","▢ una sala con nombre. Tócala para añadirla a tu recorrido.","▢ 이름이 있는 전시실. 눌러서 동선에 추가하세요.","▢ một phòng có tên. Chạm để thêm vào lộ trình của bạn."],
"· · · a corridor we have opened": ["· · · 我们已开通的通道","· · · un pasillo que hemos abierto","· · · 우리가 개설한 통로","· · · một hành lang chúng tôi đã mở"],
"👣 your route": ["👣 你的路线","👣 tu ruta","👣 당신의 동선","👣 lộ trình của bạn"],
"Fifth Avenue is to the right; Central Park to the left.": ["右侧是第五大道，左侧是中央公园。","La Quinta Avenida está a la derecha; Central Park a la izquierda.","오른쪽이 5번가, 왼쪽이 센트럴 파크입니다.","Đại lộ số Năm ở bên phải; Công viên Trung tâm ở bên trái."],
"Your walk": ["你的路线","Tu recorrido","당신의 동선","Lộ trình của bạn"],
"Nothing picked yet": ["尚未选择","Nada elegido todavía","아직 선택한 곳이 없습니다","Chưa chọn gì"],
"Tap rooms on the sheet, in the order you want to see them. The Grand Staircase is added by itself when your route changes floors.": ["按你想参观的顺序点选图纸上的展厅。当路线换层时，大楼梯会自动加入。","Toca las salas en la lámina, en el orden en que quieras verlas. La Gran Escalera se añade sola cuando tu ruta cambia de planta.","보고 싶은 순서대로 도면의 전시실을 누르세요. 동선이 층을 바꾸면 대계단이 저절로 추가됩니다.","Chạm vào các phòng trên bản vẽ theo thứ tự bạn muốn xem. Cầu thang Lớn sẽ tự được thêm vào khi lộ trình đổi tầng."],
"Share this walk": ["分享这条路线","Compartir este recorrido","이 동선 공유하기","Chia sẻ lộ trình này"],
"Save this walk": ["保存这条路线","Guardar este recorrido","이 동선 저장하기","Lưu lộ trình này"],
"Start over": ["重新开始","Empezar de nuevo","다시 시작","Bắt đầu lại"],
"This page is a drawing and a plan, not the museum. Hours, tickets and closures live at metmuseum.org. Our schematic simplifies; the building will always be bigger than the sheet. Gallery contents shift over years, so we name wings and anchors, never gallery numbers. Every city's corridors live in": ["本页是一份图纸与计划，而非博物馆本身。开放时间、门票与闭馆信息请见 metmuseum.org。我们的示意图有所简化；建筑永远比图纸更大。展品陈列会随年份变动，因此我们只标注展区与地标，从不标注展厅编号。每座城市的通道都收录在","Esta página es un dibujo y un plan, no el museo. Los horarios, entradas y cierres están en metmuseum.org. Nuestro esquema simplifica; el edificio siempre será más grande que la lámina. El contenido de las salas cambia con los años, así que nombramos alas y referencias, nunca números de sala. Los pasillos de cada ciudad están en","이 페이지는 도면이자 계획이며 박물관 자체가 아닙니다. 운영 시간, 입장권, 휴관 정보는 metmuseum.org에 있습니다. 우리의 개략도는 단순화한 것이며, 건물은 언제나 도면보다 큽니다. 전시 내용은 해가 지나며 바뀌므로 우리는 전시관과 기준점만 이름 붙이고 전시실 번호는 쓰지 않습니다. 모든 도시의 통로는 여기에 있습니다:","Trang này là một bản vẽ và một kế hoạch, không phải bảo tàng. Giờ mở cửa, vé và lịch đóng cửa có tại metmuseum.org. Sơ đồ của chúng tôi được giản lược; tòa nhà luôn lớn hơn bản vẽ. Nội dung trưng bày thay đổi qua năm tháng, nên chúng tôi chỉ gọi tên các khu và điểm mốc, không bao giờ dùng số phòng. Hành lang của mọi thành phố đều nằm trong"],
"; a saved walk follows your sign-in to any device.": ["；已保存的路线会随你的登录同步到任何设备。","; un recorrido guardado sigue tu sesión en cualquier dispositivo.","; 저장된 동선은 로그인만 하면 어떤 기기에서도 따라옵니다.","; lộ trình đã lưu sẽ theo đăng nhập của bạn tới mọi thiết bị."],
"No visitor cities have been located yet since the last deploy. As people visit, their cities appear on the map here.": ["自上次部署以来尚未定位到访客城市。随着人们来访，他们的城市会出现在这里的地图上。","No se ha localizado ninguna ciudad de visitantes desde el último despliegue. A medida que la gente visite, sus ciudades aparecerán en el mapa.","마지막 배포 이후 아직 확인된 방문자 도시가 없습니다. 사람들이 방문하면 그들의 도시가 여기 지도에 나타납니다.","Chưa xác định được thành phố nào của khách kể từ lần triển khai gần nhất. Khi có người ghé thăm, thành phố của họ sẽ hiện trên bản đồ này."],
...
# ---- write the engine and one pack per language ----------------------
#
# The dictionary used to be baked into i18n.js: 1123 entries times four
# languages, 265 KB, downloaded by everyone. An English reader, most of
# them, got Chinese, Spanish, Korean and Vietnamese and used none of it,
# on every page, and after gzip it was still the single largest asset on
# the site.
#
# So the engine ships empty and fetches the one pack it needs. English
# needs no pack at all, because English is the source text already on the
# page. Nobody pays for a language they are not reading.
sizes = []
_stamp = hashlib.sha1()
for lang in LANGS_ORDER:
    pack = {k: v[lang] for k, v in DICT.items() if v.get(lang)}
    js = ("/* Plateau Strategy -- %s pack. Generated by build_i18n.py. */\n"
          "window.psxPack && window.psxPack(%s, %s);\n"
          % (lang, json.dumps(lang), json.dumps(pack, ensure_ascii=False)))
    path = os.path.join(PROJ, "i18n.%s.js" % lang)
    open(path, "w", encoding="utf-8").write(js)
    _stamp.update(js.encode("utf-8"))
    sizes.append((lang, len(pack), len(js)))
